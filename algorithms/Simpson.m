...
%This function uses Simpson's 1/3 Rule and, if there are an odd number of
%intervals, the trapezoidal rule to compute an integral approximation of
%inputted values. 
...
if c>0
    ...
    I=I+((h/4)*(y(l-1)+y(l)/2));  %Adds the last interval to the integral using the Trap Rule
